...
const char *ssid =  "DIR2B";   // name of your WiFi network
const char *password =  "%defence:095"; // password of the WiFi network

const byte SWITCH_PIN = 2;           // Pin to control the light with
const char *ID = "Bed";  // Name of our device, must be unique
const char *TOPIC = "main/bed/black";  // Topic to subcribe to

IPAddress broker(192,168,1,110); // IP address of your MQTT broker eg. 192.168.1.50
WiFiClient wclient;
